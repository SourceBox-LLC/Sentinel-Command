// Smoke tests for InstallCameraNodeCard — the in-app CameraNode install
...
import InstallCameraNodeCard from '../../src/components/InstallCameraNodeCard.jsx'
...
describe('InstallCameraNodeCard', () => {
  it('renders the initial CTA without revealing credentials', () => {
    render(<InstallCameraNodeCard />)
  ...
  it('switches to the Windows tab and shows the MSI download path', async () => {
    ...
    const downloadLink = screen.getByRole('link', {
      name: /Download CameraNode for Windows/i,
    })
