      ...
      <div className="pricing-faq">
        ...
        <div className="pricing-faq-grid">
          ...
          <div className="pricing-faq-item">
            ...
            <p>You can cancel anytime and keep your paid features through the end of the period you've already paid for. Fees are billed in advance and are otherwise non-refundable — we don't pro-rate unused time on a voluntary cancellation. We always honor refunds required by law, including the EU/UK consumer right of withdrawal, and we'll make it right at our discretion for things like a confirmed extended outage. Full details are in the <a href="https://sentinel-command.com/legal/terms">Terms</a> (Section 6). Reach out before starting a chargeback and we'll sort it directly.</p>
          </div>
          <div className="pricing-faq-item">
